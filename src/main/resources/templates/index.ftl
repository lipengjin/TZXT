...
<head>
    ...
    <link href="${request.contextPath}/static/css/light.css" rel="stylesheet" type="text/css" id="style_color"/>
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
										...
										<span class="photo">
										<img src="${request.contextPath}/static/images/avatar2.jpg" class="img-circle" alt="">
										</span>
                                            <span class="subject">
										<span class="from">
										Lisa Wong </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="${request.contextPath}/static/images/avatar3.jpg" class="img-circle" alt="">
										</span>
                                            <span class="subject">
										<span class="from">
										Richard Doe </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="${request.contextPath}/static/images/avatar1.jpg" class="img-circle" alt="">
										</span>
                                            <span class="subject">
										<span class="from">
										Bob Nilson </span>
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                <li class="start active ">
                    <a href="javascript:void(0);">
                        <i class="icon-home"></i>
                        <span class="title">采油工程信息管理系统</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:;">

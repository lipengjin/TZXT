                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal form-row-seperated"
                              action="${request.contextPath}/role/saveRole"
                              method="post">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="roleName"
                                               placeholder="角色名称" value="" id="roleNameInput">
                                    </div>
                                </div>
                                <#if ledgers??>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control select2_sample1" multiple id="authSelect" name="ledgerIds">

...
<head>
    ...
    <link href="${request.contextPath}/static/css/login-soft.css" rel="stylesheet" type="text/css"/>
    ...
    <link id="style_color" href="${request.contextPath}/static/css/default.css" rel="stylesheet" type="text/css"/>

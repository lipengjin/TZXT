...
<div class="logo">
    <a href="javascript:void(0);">
        <h2 class="font-grey-gallery">台账查询系统</h2>
...
<div class="content">
    ...
    <form class="login-form" action="${request.contextPath}/validate" method="post">
        <h3 class="form-title">普通用户账号登录</h3>
        ...
        <div class="form-group">
            <input class="hidden" value="2" name="accountType"/>
        ...
        <div class="form-actions">
            <a class="btn blue pull-right" type="button" href="${request.contextPath}/login">
                切换到管理员账号登录 <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" name="r_password"/>
                </div>
            </div>
        </div>
        <div class="form-group">

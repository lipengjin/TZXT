...
<body>
<div class="hidden">
    <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=298 height=52 src="//music.163.com/outchain/player?type=0&id=742108171&auto=1&height=32"></iframe>
</div>
<div id="main">
    ...
    <div id="wrap">
        <div id="text">
            <div id="code"><font color="#FF0000">
                <span class="say"> 李芃锦，不知道你会不会最后再拉取一次代码，因为我并没有告诉过你</span><br>
                <span class="say"> 不知道，你从重新运行了项目，会不会无意间看到这些</span><br>
                <span class="say"> 不知道，你看到这些会是什么样的心情：惊喜？感动？或者是无所谓。</span><br>
                <span class="say"> 这些，对我来说似乎已经不重要</span><br>
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                ...
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                <span class="say"> 我不是一个善于表达感情的人</span><br>
                <span class="say"> 我爱你爱你爱你爱你 forever</span><br>
                <span class="say"> 未完...</span><br>
                <span class="say"><span class="space"></span> -- 一个爱你的傻子--</span> </font>
                </p>
            </div>
        </div>
        <div id="clock-box"><span class="STYLE1"></span><font color="#33CC00">亲爱的，我默默喜欢你</font> <span class="STYLE1">已经是……</span>
            <div id="clock"></div>
        </div>
...
<script type="text/javascript">
    (function () {
        ...
        var textAnimate = eval(Jscex.compile("async", function () {
            ...
            together.setFullYear(2013, 10, 15); 			//时间年月日
